...
4. **Ask clarifying questions before implementation** - Clarify any uncertainties or lack of clarity before implementing, to minimize assumptions
5. **Implement tasks sequentially** - Complete in order
6. **Commit changes** with a relevant git commit message of up to 7 lines long, omitting any mentions of AI contributions, like Claude Code
