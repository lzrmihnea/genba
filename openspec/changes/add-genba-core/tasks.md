...
- [ ] 2.3 Entity + repository + service + DTO under `eu.px.genba.attachment.channel.*`.
...
- [ ] 4.2 Entity + repository + service + controller + DTO under `eu.px.genba.project.*`. Service applies org scope from active org.
